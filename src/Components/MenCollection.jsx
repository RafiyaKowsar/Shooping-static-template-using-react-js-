...
const MenCollection = (props) => {
     const {title, image1, image2, image3, image4, image5, image6,image7,image8} =props.menFashion ;
     const { price1, price2, price3, price4, price5,  price6 , price7,  price8} =props.menFashion ;
  return (
    <div id='mendiv'>
      <div >
          <h1 style={{textAlign:"center"}}> {title}</h1>
      <div className="bannerBox">
        <img src="src/assets/Mens/bannermen.jpg" alt="" />
      </div>
      </div>
